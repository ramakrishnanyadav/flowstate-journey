...
function Dashboard({ showJourneyPage, showConnectPage, showAiMentorPage }) {
  ...
  if (isActive) {
    return <FocusSandbox goal={goal} mode={mode} time={time} onEndSession={handleEndSessionEarly} text={writingText} onTextChange={onTextChange} code={code} onCodeChange={onCodeChange} />;
  }
